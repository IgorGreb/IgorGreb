...
Я розробник, який спеціалізується на створенні мобільних застосунків, збереженні цифрової спадщини та побудові зручних користувацьких інтерфейсів.

## 🚀 Чим я зараз займаюсь
- 🏛 Розвиваю [DigitalHeritage-Lab](https://github.com/DigitalHeritage-Lab) та проєкт **MemoryMap** — кросплатформний додаток для оцифрування некрополів.
- 💻 Працюю з Flutter та створюю сучасні, швидкі застосунки.
